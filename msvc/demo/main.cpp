...
LRESULT CALLBACK button_click(HEXOBJ hObj, INT nID, INT nCode, WPARAM wParam, LPARAM lParam)
{
    void (*buttonProc[])(HWND) = {
        ...
        test_flowscrollview,      // 167测试流式滚动容器
        test_prototypeboard,      // 168测试原型画板
        test_candlestickchart,     // 169测试K线图
        test_imgpreviewlistview,  // 170测试图像预览列表
        test_edit_material,       //171测试素材编辑框
        test_consolebox,           //172测试日志框
        test_scrollbarlabel        //173测试滚动条标签
    };
