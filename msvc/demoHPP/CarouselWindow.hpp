...
public:
	void CreateCarouselWindow(HWND pOwner)
	{
		...
		m_carousel.AddImage(ExImage(L"../demo/res/carousel/1.jpeg"));
		m_carousel.AddImage(ExImage(L"../demo/res/carousel/2.jpeg"));
		m_carousel.AddImage(ExImage(L"../demo/res/carousel/3.jpeg"));
