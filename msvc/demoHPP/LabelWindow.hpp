...
public:
	void CreateLabelWindow(HWND pOwner)
	{
		...
		m_label.SetBackgroundImageFromFile(L"../demo/res/Loading.gif", 0, 0, BACKGROUND_REPEAT_ZOOM, 0, BACKGROUND_FLAG_PLAYIMAGE, 255, TRUE);
		...
		m_label2.SetBackgroundImageFromFile(L"../demo/res/409.dds", 0, 0, BACKGROUND_REPEAT_ZOOM, 0, BACKGROUND_FLAG_PLAYIMAGE, 255, TRUE);
