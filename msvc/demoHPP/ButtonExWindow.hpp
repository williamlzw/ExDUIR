...
public:
	void CreateButtonExWindow(HWND pOwner)
	{
		...
		m_button4.SetIcon(ExImage(L"../test/buttonex/5.png"));

		EX_IMAGEINFO IMG0 = { 0 };
		IMG0.imgNormal = ExImage(L"../test/buttonex/4正常.png").m_image;
		IMG0.imgHover = ExImage(L"../test/buttonex/4点燃.png").m_image;
		IMG0.imgDownOrChecked = ExImage(L"../test/buttonex/4按下.png").m_image;
		...
		EX_IMAGEINFO IMG = { 0 };
		IMG.imgNormal = ExImage(L"../test/buttonex/正常.png").m_image;
		IMG.imgHover = ExImage(L"../test/buttonex/进入.png").m_image;
		IMG.imgDownOrChecked = ExImage(L"../test/buttonex/按下.png").m_image;
		...
		m_button9.SetIcon(ExImage(L"../test/buttonex/4.png"));
		...
		m_button10.SetIcon(ExImage(L"../test/buttonex/3.png"));
