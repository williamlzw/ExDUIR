                      ...
                      int properityCount, LPVOID createEffect)
{
    ...
    if (!isRegistered) {
        ...
        hr = g_Ri.pD2Dfactory->RegisterEffectFromString(
            guid, pProperityXml, bindings, properityCount, (PD2D1_EFFECT_FACTORY)createEffect);
        return hr == S_OK;
    }
    return isRegistered;
}
...
{
    return ((ID2D1Effect*)hEffect)
               ->SetValueByName(lpszProperityName, D2D1_PROPERTY_TYPE_FLOAT, (BYTE*)&value, 4) ==
           S_OK;
}
...
BOOL _effect_set_vector2(HEXEFFECT hEffect, PCWSTR lpszProperityName, float value1, float value2)
{
    ...
    return ((ID2D1Effect*)hEffect)
               ->SetValueByName(lpszProperityName, D2D1_PROPERTY_TYPE_VECTOR2, (BYTE*)&vec, 8) ==
           S_OK;
}
                         ...
                         float value3)
{
    ...
    return ((ID2D1Effect*)hEffect)
               ->SetValueByName(lpszProperityName, D2D1_PROPERTY_TYPE_VECTOR3, (BYTE*)&vec, 12) ==
           S_OK;
}
                         ...
                         float value3, float value4)
{
    ...
    return ((ID2D1Effect*)hEffect)
               ->SetValueByName(lpszProperityName, D2D1_PROPERTY_TYPE_VECTOR4, (BYTE*)&vec, 16) ==
           S_OK;
}
...
{
    return ((ID2D1Effect*)hEffect)
               ->SetValueByName(lpszProperityName, D2D1_PROPERTY_TYPE_UINT32, (BYTE*)&value, 4) ==
           S_OK;
}
...
{
    return ((ID2D1Effect*)hEffect)
               ->SetValueByName(lpszProperityName, D2D1_PROPERTY_TYPE_INT32, (BYTE*)&value, 4) ==
           S_OK;
}
...
{
    return ((ID2D1Effect*)hEffect)
               ->SetValueByName(lpszProperityName, D2D1_PROPERTY_TYPE_BOOL, (BYTE*)&value, 4) ==
           S_OK;
}
...
BOOL _shader_loadfromfile(LPVOID pEffectContext, LPCWSTR csoFileNameInOut, const GUID& shaderID)
{
    ...
    hr                         = ((ID2D1EffectContext*)pEffectContext)
             ->LoadPixelShader(shaderID, (BYTE*)lpShaderBytecode, nShaderBytecodeLength);
    if (FAILED(hr)) {
        pBlob->Release();
        return FALSE;
    }
