...
void CALLBACK _easing_calc_curve(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                 size_t param)
{
...
void _easing_progress(HEXEASING pEasing)
{
    ...
    while (nTimes > 0 || (nMode & EASING_MODE_CYCLE) == EASING_MODE_CYCLE) {
        ...
        while (i <= nFrameCount) {
            ...
            if (((EX_EASING*)pEasing)->nState == EASING_STATE_PAUSE) {
                WaitForSingleObject(((EX_EASING*)pEasing)->hEventPause,
                                    INFINITE);   // 停住最大程度节省CPU
    ...
    if ((nMode & EASING_MODE_RELEASECURVE) == EASING_MODE_RELEASECURVE &&
        uType == EASING_TYPE_CURVE) {
...
INT _easing_calc(LPVOID lpEasingProc, INT nType, LPVOID pEasingContext, INT nStart, INT nStop,
                 DOUBLE nProgress, DOUBLE* nCurrent)
{
    if (lpEasingProc != 0) {
...
void CALLBACK _easing_calc_line(DOUBLE nProgress, DOUBLE* nCurrent,
                                std::vector<std::vector<FLOAT>> aNodes, INT nCount, LPVOID param)
{
...
void CALLBACK _easing_calc_bezier(DOUBLE nProgress, DOUBLE* nCurrent,
                                  std::vector<std::vector<FLOAT>> aNodes, INT nCount, LPVOID param)
{
    if (nCount <= 0) return;
...
void CALLBACK _easing_calc_Bspline(DOUBLE nProgress, DOUBLE* nCurrent,
                                   std::vector<std::vector<FLOAT>> aNodes, INT nCount, LPVOID param)
{
    DOUBLE nPst = nProgress * 100;
    DOUBLE n    = 0;
...
void CALLBACK _easing_calc_Linear(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                  LPVOID param)
{
...
void CALLBACK _easing_calc_InQuad(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                  LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_OutQuad(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                   LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_InOutQuad(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                     LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_InCubic(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                   LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_OutCubic(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                    LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_InOutCubic(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                      LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_InQuart(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                   LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_OutQuart(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                    LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_InOutQuart(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                      LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_InQuint(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                   LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_OutQuint(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                    LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_InOutQuint(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                      LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_InSine(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                  LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_OutSine(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                   LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_InOutSine(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                     LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_InExpo(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                  LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_OutExpo(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                   LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_InOutExpo(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                     LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_InCirc(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                  LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_OutCirc(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                   LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_InOutCirc(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                     LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_InBounce(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                    LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_OutBounce(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                     LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_InOutBounce(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                       LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_InBack(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                  LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_OutBack(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                   LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_InOutBack(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                     LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_InElastic(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                     LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
    ...
    DOUBLE _st = nProgress - 1;
    *nCurrent =
        -(_a * pow(2, 10 * _st) * sin((DOUBLE)(_st * _d - _s) * 2 * 3.1415926 / _p)) + nStart;
}

void CALLBACK _easing_calc_OutElastic(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                      LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
    ...
    *nCurrent =
        _a * pow(2, nProgress * -10) * sin((DOUBLE)(nProgress * _d - _s) * 2 * 3.1415926 / _p) +
        nStop;
}

void CALLBACK _easing_calc_InOutElastic(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                        LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
    ...
    if (_st < 1) {
        _st = _st - 1;
        *nCurrent =
            -0.5 * _a * pow(2, 10 * _st) * sin((DOUBLE)(_st * _d - _s) * 2 * 3.1415926 / _p) +
            nStart;
        return;
    }
    _st = _st - 1;
    *nCurrent =
        _a * pow(2, -10 * _st) * sin((DOUBLE)(_st * _d - _s) * 2 * 3.1415926 / _p) * 0.5 + nStop;
}
...
void CALLBACK _easing_calc_Clerp(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                 LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
...
void CALLBACK _easing_calc_Spring(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                  LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
    DOUBLE _st = (sin(nProgress * 3.1415826 * (0.2 + 2.5 * nProgress * nProgress * nProgress)) *
                      pow(1 - nProgress, 2.2) +
                  nProgress) *
                 (1 + 1.2 * (1 - nProgress));
...
void CALLBACK _easing_calc_Punch(DOUBLE nProgress, INT nStart, INT nStop, DOUBLE* nCurrent,
                                 LPVOID param)
{
    if (nProgress < 0) nProgress = 0;
    if (nProgress > 1) nProgress = 1;
    ...
    *nCurrent =
        nStop * pow(2, -10 * nProgress) * sin((DOUBLE)(nProgress - _s) * 2 * 3.1415926 / _p);
}
                         ...
                         LONG_PTR param1, LONG_PTR param2, LONG_PTR param3, LONG_PTR param4)
{
    ...
    if (pContext != 0) {
        ...
        std::vector<LPVOID> lpCalcProcs = {
            &_easing_calc_Linear,      &_easing_calc_Clerp,     &_easing_calc_Spring,
            &_easing_calc_Punch,       &_easing_calc_InQuad,    &_easing_calc_OutQuad,
            ...
            &_easing_calc_InOutCirc,   &_easing_calc_InBounce,  &_easing_calc_OutBounce,
            &_easing_calc_InOutBounce, &_easing_calc_InBack,    &_easing_calc_OutBack,
            &_easing_calc_InOutBack,   &_easing_calc_InElastic, &_easing_calc_OutElastic,
            &_easing_calc_InOutElastic};
