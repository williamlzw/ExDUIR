...
void _cefbrowser_setcursor(HEXOBJ hObj, DWORD dwCursorType)
{
    ...
    std::vector<INT> arrCurs = {32512, 32515, 32649, 32513, 32514, 32651, 32644, 32645, 32643,
                                32642, 32645, 32642, 32643, 32644, 32645, 32644, 32643, 32642,
                                32644, 32645, 32640, 32644, 32644, 32643, 32642, 32645, 32642,
                                32643, 32644, 32646, 32513, 32512, 32512, 32512, 32650, 32648,
                                32512, -1,    32648, 32515, 32646, 32512, 32512, 32512};
                                   ...
                                   bool* pbHWEBVIEWd, void* lParam)
{
    if (uMsg == type_BCreated) {
        ...
        Ex_ObjDispatchNotify(hObj, CEFBROWSER_EVENT_FAVICONURLCHANGE, (WPARAM)icon1.c_str(),
        (LPARAM)icon2.c_str());*/
    }
