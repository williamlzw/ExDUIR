    ...
    if (Ex_ObjBeginPaint(hObj, &ps)) {
        ...
        if (lpText) {
            ...
            _canvas_drawtext(ps.hCanvas,
                             ...
                             -1,
                             ps.dwTextFormat,
                             ps.rcText.left + radius + textoffset,
                             ps.rcText.top,
                             ps.rcText.right,
                             ps.rcText.bottom);
        }
        ...
        _path_beginfigure2(hPath,
                           ps.rcPaint.left + textoffset + rcText.right + 5 + radius,
                           ps.rcPaint.top + rcText.bottom / 2);
        _path_addarc(hPath,
                     ps.rcPaint.right - radius,
                     ps.rcPaint.top + rcText.bottom / 2,
                     ps.rcPaint.right,
                     ps.rcPaint.top + rcText.bottom / 2 + radius,
                     radius,
                     radius,
                     TRUE);
        _path_addarc(hPath,
                     ps.rcPaint.right,
                     ps.rcPaint.bottom - radius,
                     ps.rcPaint.right - radius,
                     ps.rcPaint.bottom,
                     radius,
                     radius,
        ...
        _path_addline(hPath,
                      ps.rcPaint.left + radius,
                      ps.rcPaint.top + rcText.bottom / 2,
                      ps.rcText.left + radius + textoffset - 5,
                      ps.rcPaint.top + rcText.bottom / 2);
        ...
        _canvas_drawpath(
            ps.hCanvas, hPath, hBrush, strokewidth, D2D1_DASH_STYLE::D2D1_DASH_STYLE_SOLID);
        _path_destroy(hPath);
