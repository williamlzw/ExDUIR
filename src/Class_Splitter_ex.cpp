...
LRESULT CALLBACK _splitter_proc(HWND hWnd, HEXOBJ hObj, INT uMsg,
	...
	case SPLITTER_MESSAGE_SET_COLOR:
	{
		Ex_ObjSetLong(hObj, SPLITTER_LONG_COLOR, wParam);
		break;
	}
	case SPLITTER_MESSAGE_GET_COLOR:
	{
		return Ex_ObjGetLong(hObj, SPLITTER_LONG_COLOR);
	}
	case SPLITTER_MESSAGE_SET_FIXEDPANEL:
	{
		Ex_ObjSetLong(hObj, SPLITTER_LONG_FIXEDPANEL, wParam);
		break;
	}
	case SPLITTER_MESSAGE_SET_SIZE:
	{
		Ex_ObjSetLong(hObj, SPLITTER_LONG_SIZE, wParam);
		break;
	}
	default:
		break;
