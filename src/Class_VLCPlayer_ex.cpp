...
{
	Ex_ObjRegister(L"VLCPlayer", OBJECT_STYLE_VISIBLE, OBJECT_STYLE_EX_FOCUSABLE | OBJECT_STYLE_EX_TABSTOP, DT_NOPREFIX | DT_SINGLELINE | DT_CENTER | DT_VCENTER, 2 * sizeof(size_t), NULL, 0, _vlcplayer_proc);
}
...
unsigned int VLCPlayer::vlcVideoFormatCallback(void** object, char* chroma, unsigned int* width, unsigned int* height,
