...
/// <param name="phImg">返回图像</param>
/// <returns></returns>
BOOL _img_createfromsvgfile(LPCWSTR lpwzFilename, EXARGB color,
                            HEXIMAGE* phImg);
...
/// <returns></returns>
BOOL Ex_ObjSetBackgroundImageFromSvgBuf(EXHANDLE handle, CHAR* svgBuf,
                                        EXARGB color, INT x, INT y,
