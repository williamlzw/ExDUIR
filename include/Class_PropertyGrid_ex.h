...
#define PROPERTYGRID_LONG_ITEMTEXTCOLOR 10
// 属性框属性_表头背景色
#define PROPERTYGRID_LONG_HEADERBACKGROUNDCOLOR 11
// 属性框属性_编辑框标识
#define PROPERTYGRID_LONG_HOBJEDIT 12
// 属性框属性_组合框标识
#define PROPERTYGRID_LONG_HOBJCOMBOBOX 13
// 属性框属性_颜色框标识
#define PROPERTYGRID_LONG_HOBJCOLORPICKER 14
// 属性框属性_日期框标识
#define PROPERTYGRID_LONG_HOBJDATEBOX 15
// 属性框属性_按钮标识
#define PROPERTYGRID_LONG_HOBJBUTTON 16
// 属性框属性_是否绘制表头
...
// 属性框属性_项目默认背景色 默认白色
#define PROPERTYGRID_LONG_ITEMBACKGROUNDCOLOR 21
