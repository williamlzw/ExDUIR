...
// 属性_属性框_背景色
#define PROPERTYGRID_LONG_BKG_COLOR 1
// 属性_属性框_纵坐标偏移
#define PROPERTYGRID_LONG_TOP_OFFSET 2
// 属性_属性框_默认_内容字体
#define PROPERTYGRID_LONG_TEXT_FONT 3
// 属性_属性框_行高
#define PROPERTYGRID_LONG_LINEHEIGHT 4
// 属性_属性框_选中项目
#define PROPERTYGRID_LONG_SELITEM 5
// 属性_属性框_热点项目
#define PROPERTYGRID_LONG_HOTITEM 6
// 属性_属性框_列宽
#define PROPERTYGRID_LONG_COLUMNWIDTH 7
// 属性_属性框_热点项目背景色
#define PROPERTYGRID_LONG_ITEMHOTCOLOR 8
// 属性_属性框_选中项目背景色
#define PROPERTYGRID_LONG_ITEMSELCOLOR 9
// 属性_属性框_项目背景色
#define PROPERTYGRID_LONG_ITEMBACKGROUNDCOLOR 10
// 属性_属性框_编辑框句柄
#define PROPERTYGRID_LONG_HOBJEDIT 11
// 属性_属性框_组合框句柄
#define PROPERTYGRID_LONG_HOBJCOMBOBOX 12
// 属性_属性框_颜色框句柄
#define PROPERTYGRID_LONG_HOBJCOLORPICKER 13
// 属性_属性框_日期框句柄
#define PROPERTYGRID_LONG_HOBJDATEBOX 14
// 属性_属性框_按钮句柄
#define PROPERTYGRID_LONG_HOBJBUTTON 15
