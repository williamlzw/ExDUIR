...
typedef LONG_PTR(CALLBACK* ArrayComparePROC)(LPVOID, LONG_PTR, size_t, LONG_PTR, size_t, size_t,
                                             INT);
...
LONG_PTR Array_SetEvent(array_s* pArray, INT nEvent, LONG_PTR index1, size_t pvValue = NULL,
                        LONG_PTR index2 = 0, INT reasen = 0);
